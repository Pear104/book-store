			...
			<div class="grid grid-cols-6">
				<div class="border p-4 col-span-5">
					...
					<div class="flex gap-4 text-sm font-bold mt-4">
						<div class="text-lg mr-12">Overview</div>
						<div class="text-slate-400 flex gap-4 flex-col">
							<!--<StarRatingOverview />-->
							<div class="flex gap-8 items-center">
								<!--<StarRating />-->
								<div class="text-xs flex items-center gap-4">
									<div class="flex gap-1">
										<span class="fa fa-star ${currentProduct.pages >= 1 ? "text-yellow-500" : ""}"></span>
										<span class="fa fa-star ${currentProduct.pages >= 2 ? "text-yellow-500" : ""}"></span>
										<span class="fa fa-star ${currentProduct.pages >= 3 ? "text-yellow-500" : ""}"></span>
										<span class="fa fa-star ${currentProduct.pages >= 4 ? "text-yellow-500" : ""}"></span>
										<span class="fa fa-star ${currentProduct.pages >= 5 ? "text-yellow-500" : ""}"></span>
									</div>
								</div>
								<progress value="28" max="100" class="h-4 w-[600px]"></progress>
								<div>250</div>
							</div>
						</div>
					</div>
